		...
		$.ajax({
			...
			success : function(res) {
				if (res.found) {
					...
					location.href = "/user/resultId?userId=" + res.userId;
				} else {
					alert("아이디 찾기 실패");
				}
			},
...
input[type="text"], input[id="userEmailDomain"], select[id="select"] {
...
<body>
	...
	<main class="main">
		<h3>동물이야기 아이디 찾기</h3>
		<form id="findIdForm" onsubmit="return login();" style="margin-top: 10px;">
			<div>
				<label for="userName" style="font-weight: bold;">고객명 : </label> <input
					type="text" id="userName" name="userName">
			</div>
			
			<div style="margin-top: 10px;">
				<label for="userEmail" style="font-weight: bold;">이메일 : </label><input
					type="text" name="userEmail" id="userEmail" value=""
					placeholder="이메일 입력">
